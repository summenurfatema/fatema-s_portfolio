    ...
    return (
      ...
      <div className="w-80 md:w-[570px]">
        ...
        <p className="py-3">
          ...
          BSc course.After that I've completed my Web Development Course to
          develop myself as a Web Developer.
        </p>
        <p className="mb-4">
          Now, I can proudly say that I'm a Front-end Web Developer. I can build
          awesome and highly responsive websites. My resume is given bellow
          through which you can know more about me.{" "}
        </p>
        <div className="flex flex-col space-y-3 md:flex-row md:space-y-0">
          ...
          <a href="/#contact">
            ...
            {/* img */}
            <div>
<img src={fatema} className='h-96 w-96' alt='fatema'/>            
</div>
        </div>
    );
};
